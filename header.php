        ...
        <div class="container clearfix">
            ...
            <div class="collapse navbar-collapse clearfix" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a class="tag_menu_1" href="index.php">HOME</a>
                    </li>
					
					<li>
						   <a class="tag_menu" href="event.php">EVENT</a>

						</li>
                    <li>
                        <a class="tag_menu" href="artist.php">ARTISTS</a>
                    </li>
					<li>
                        <a class="tag_menu" href="gallery.php">GALLERY</a>
                    </li>
					<li class="dropdown">
						  <a class="tag_menu border_none" href="#" data-toggle="dropdown" role="button" aria-expanded="false">CATEGORY<span class="caret"></span></a>
						  <ul class="dropdown-menu drop_2" role="menu">
							<?php
								...
								{
								?>
								<li><a href="category.php?cid=<?php echo $rcat[0]; ?>" class="drop-text"><?php echo $rcat[1]; ?></a></li>
								<?php
								}
							
							/*<li><a href="gallery.php">SKETCH</a></li>
							<li><a href="gallery.php">OIL PAINTINGS</a></li>
							<li><a href="gallery.php">KNIFE PAINTINGS</a></li>*/
							?>
						  </ul>
						</li>
                    
					<li>
                        <a class="tag_menu" href="aboutus.php">ABOUT US</a>
                    </li>
