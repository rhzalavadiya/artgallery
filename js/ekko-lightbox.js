  ...
  EkkoLightbox.prototype = {
    ...
    updateTitleAndFooter: function() {
      ...
      if (title || this.options.always_show_close) {
        header.css('display', '').find('.modal-title').php(title || "&nbsp;");
      } else {
        header.css('display', 'none');
      }
      if (caption) {
        footer.css('display', '').php(caption);
      } else {
    ...
    showLoading: function() {
      this.lightbox_body.php('<div class="modal-loading">' + this.options.loadingMessage + '</div>');
      return this;
    },
    showYoutubeVideo: function(id) {
      ...
      return this.showVideoIframe('//www.youtube.com/embed/' + id + '?badge=0&autoplay=1&php=1' + rel, width, height);
    },
    ...
    showInstagramVideo: function(id) {
      ...
      this.resize(width);
      height = width + 80;
      this.lightbox_body.php('<iframe width="' + width + '" height="' + height + '" src="' + this.addTrailingSlash(id) + 'embed/" frameborder="0" allowfullscreen></iframe>');
    ...
    showVideoIframe: function(url, width, height) {
      height = height || width;
      this.resize(width);
      this.lightbox_body.php('<div class="embed-responsive embed-responsive-16by9"><iframe width="' + width + '" height="' + height + '" src="' + url + '" frameborder="0" allowfullscreen class="embed-responsive-item"></iframe></div>');
      this.options.onContentLoaded.call(this);
      if (this.modal_arrows) {
    ...
    loadRemoteContent: function(url) {
      ...
      if (!disableExternalCheck && !this.isExternal(url)) {
        ...
        this.lightbox_body.php('<iframe width="' + width + '" height="' + width + '" src="' + url + '" frameborder="0" allowfullscreen></iframe>');
        this.options.onContentLoaded.call(this);
      }
      if (this.modal_arrows) {
        this.modal_arrows.css('display', 'none');
    ...
    error: function(message) {
      this.lightbox_body.php(message);
      return this;
    },
