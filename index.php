		...
		<div class="col-md-12">
		   <div class="col-sm-4">
		     <div class=" center_slide">
				<h1>BEST OPPORTUNITY<br>for Artist</h1><br>
			      <p align="center"><font style="font-family:ARIAL">here,artist can add <br>their own art in this website.</p><br>
				<h5><u>To add art register here</u></h5>
				<h4> <a href="admin/alogin.php">Artist</a></h4>
				<h6></h6>
			 </div>
		   </div>
   ...
   <div class="deals_page clearfix">
    ...
    <div class="col-sm-6">
	 <div class="deals_page_left bg_1 clearfix">
	   <div class="col-sm-5">
	    <div class="deals_page_left_1 card-image">
		 <a href="#"><img src="img/k.png" width="100%" height="185px"></a>
		</div>
	   </div>
	   <div class="col-sm-7 space_left">
	     <div class="deals_page_left_2">
